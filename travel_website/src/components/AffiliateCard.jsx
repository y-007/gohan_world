...
const AffiliateCard = ({ badge, name, nameLink, tagline, pros = [], link, linkText, sponsored }) => (
  <div className="affiliate-card">
    ...
    <h3 className="affiliate-card__name">
      {nameLink ? <a href={nameLink} target="_blank" rel="noopener noreferrer sponsored">{name}</a> : name}
    </h3>
