...
const Hero = () => {
  return (
    <section id="home" className='header-title-wrapper'>
      ...
      <div className='about-title'>
         <span> <p>Gohan World (gohanworld.com) is a USA⇄Japan travel and insurance</p>
       </span>
...
Travel with curiosity, confidence, and the comfort of being prepared for whatever the journey brings. <p>At Gohan World, I believe travel should feel exciting—not confusing.</p>
</p>
      </div>
