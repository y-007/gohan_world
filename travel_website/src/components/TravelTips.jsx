...
const tips = [
  { icon: '🎌', title: 'Get an IC Card in Japan',       body: 'A <a href="/articles/suica-vs-pasmo-ic-card-japan"><strong>Suica or Pasmo</strong></a> card works on trains, subways, buses, and even convenience stores across Japan. Load it once and tap your way everywhere.', html: true },
  ...
  { icon: '🌐', title: 'Pocket Wi-Fi or eSIM',           body: 'Rent a pocket Wi-Fi at the airport or set up an <a href="/articles/esim-japan-beginners-guide"><strong>eSIM</strong></a> before departure. Staying connected is essential for navigation and translation apps.', html: true },
  ...
  { icon: '🧳', title: 'Ship Your Luggage Ahead (TA-Q-BIN)',        body: "Japan's <a href=\"/articles/takkyubin-japan-luggage-delivery\"><strong>takkyubin (luggage delivery)</strong></a> service lets you send bags to your next hotel for a few dollars. Travel light between cities.", html: true },
